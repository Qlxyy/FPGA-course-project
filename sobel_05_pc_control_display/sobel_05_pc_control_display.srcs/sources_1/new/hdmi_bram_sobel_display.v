...
localparam CTRL_ALGO_ADDR      = 32'h0000_900C;
...
localparam SCAN_CTRL_ALGO_REQ     = 4'd12;
localparam SCAN_CTRL_ALGO_WAIT1   = 4'd13;
localparam SCAN_CTRL_ALGO_WAIT2   = 4'd14;
...
assign ctrl_read_active = (scan_state >= SCAN_CTRL_MODE_REQ) && (scan_state <= SCAN_CTRL_ALGO_WAIT2);
    ...
    if (rst) begin
        ...
        case (scan_state)
            ...
            SCAN_CTRL_OVL_WAIT2: begin
                ...
                scan_state <= SCAN_CTRL_ALGO_REQ;
            end

            SCAN_CTRL_ALGO_REQ: begin
                bram_addr_reg <= CTRL_ALGO_ADDR;
                scan_state <= SCAN_CTRL_ALGO_WAIT1;
            end

            SCAN_CTRL_ALGO_WAIT1: begin
                scan_state <= SCAN_CTRL_ALGO_WAIT2;
            end

            SCAN_CTRL_ALGO_WAIT2: begin
                algo_sel <= bram_dout[1:0];
                scan_state <= SCAN_RUN;
